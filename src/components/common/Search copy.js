...
/**
 * @description:Search Child Component
 * @author:Dhivya.C
 * @param {*} props 
 * @returns 
 */
const Search = (props) => {
  ...
  return (
    <SearchCard className="wrapper">
      ...
      <input placeholder="Search For Recipe" onChange={searchAction}
        type="text"
        className="search" ref={searchInput} />
